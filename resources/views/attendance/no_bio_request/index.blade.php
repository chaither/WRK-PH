    ...
    <div class="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <form action="{{ route('attendance.no-bio-request.store') }}" method="POST">
            ...
            <div id="time_in_field" class="mb-4 hidden">
                ...
                <input type="time" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="requested_time_in" name="requested_time_in" value="{{ old('requested_time_in') }}">
            </div>
            <div id="time_out_field" class="mb-4 hidden">
                ...
                <input type="time" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="requested_time_out" name="requested_time_out" value="{{ old('requested_time_out') }}">
            </div>
            <div class="mb-6">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">{{ ucfirst(str_replace(['_in', '_out', 'all_', 'whole_'], [' In', ' Out', 'All ', 'Whole '], $request->type)) }}</td>
