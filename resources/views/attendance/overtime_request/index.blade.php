...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-2xl font-semibold text-gray-800 mb-4">Overtime Application</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('attendance.overtime-request.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="time" id="end_time" name="end_time" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
            <div class="mb-6">
