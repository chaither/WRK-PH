...
@section('content')
<div class="mx-6 py-6">
    <h1 class="text-2xl font-semibold text-white mb-4">My Overtime Requests</h1>
    ...
    <div class="bg-white shadow-md rounded-3xl p-6 mb-6">
        ...
        <form action="{{ route('attendance.overtime-request.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="time" class="shadow appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline" id="start_time" name="start_time" value="{{ old('start_time') }}" required>
            </div>
            <div class="mb-4">
                <label for="end_time" class="block text-gray-700 text-sm font-bold mb-2">End Time</label>
                <input type="time" class="shadow appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline" id="end_time" name="end_time" value="{{ old('end_time') }}" required>
            </div>
            <div class="mb-6">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200 text-gray-900">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-gray-900">{{ \Carbon\Carbon::parse($request->start_time)->format('h:i A') }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-gray-900">{{ \Carbon\Carbon::parse($request->end_time)->format('h:i A') }}</td>
