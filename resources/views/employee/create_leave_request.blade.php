...
<div class="container mx-auto px-4 py-8">
    ...
    <form action="{{ route('employee.leave.store') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-4">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-6">
            <label for="formal_letter" class="block text-gray-700 text-sm font-bold mb-2">Formal Letter (PDF/Docx):</label>
            <input type="file" name="formal_letter" id="formal_letter" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            <p class="text-xs text-gray-500 mt-1">Accepted formats: PDF, DOCX</p>
        </div>
