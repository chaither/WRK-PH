...
<div class="mx-6 py-6">
    ...
    <div class="mb-4">
        <input type="text" id="nobioSearch" placeholder="Search by Date (e.g. Jan 01, 2026)" class="px-4 py-2 border rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 w-full md:w-1/3">
    </div>

            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200" id="nobioTable">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const searchInput = document.getElementById('nobioSearch');
        const table = document.getElementById('nobioTable');
