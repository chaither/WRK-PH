                    ...
                    <template x-if="form.target_type === 'employees'">
                        <div class="mt-4">
                            ...
                            <select id="select_employees" x-model="form.applies_to" multiple
                                class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 bg-gray-50 text-gray-800 transition-colors duration-200 h-32">
...
<script>
    function openGovernmentContributionModal() {
        ...
        document.getElementById('governmentContributionModal')._x_data_governmentContributionData.fetchContributions();
    }
