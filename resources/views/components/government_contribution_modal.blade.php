<div id="governmentContributionModal" class="fixed inset-0 bg-transparent hidden items-center justify-center z-50 p-2" x-data="governmentContributionData()" x-init="fetchContributions()">
